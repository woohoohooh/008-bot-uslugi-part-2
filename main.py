...
# for phone in phones:
    ...
    # STAGE 7 - LOOKS "ПАСПОРТ" IN THE TEXT
    # time.sleep(3)
    # pyautogui.moveTo(211, 1055)
    # pyautogui.click()
    # time.sleep(1)
    # pyautogui.moveTo(847, 904)
    # pyautogui.rightClick()
    ...
    # with open('one.txt', encoding='utf8') as f:
    #     oke = f.read()
    #     if 'Паспорт' not in oke:
    #         continue
    #     else:

            # STAGE 8 - LOOKS "НЕДЕЙСТВИТЕЛЬНЫЙ" IN THE TEXT

            # pyautogui.hotkey('ctrl', 'a')
            # pyautogui.hotkey('ctrl', 'c')
            # time.sleep(1)
            # pyautogui.moveTo(997, 59)
            # pyautogui.click()
            # time.sleep(1)
            # pyautogui.hotkey('ctrl', 'v')
            # pyautogui.hotkey('ctrl', 's')
            ...
            # pyautogui.click()
            # time.sleep(1)
            # pyautogui.write(f'{phone} {passport}')
            # time.sleep(1)
            # pyautogui.hotkey('enter')
